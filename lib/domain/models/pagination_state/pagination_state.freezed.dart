...
class _$LoadingImpl<T> with DiagnosticableTreeMixin implements _Loading<T> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty('type', 'PaginationState<$T>.loading'));
  }
...
class _$ErrorImpl<T> with DiagnosticableTreeMixin implements _Error<T> {
  const _$ErrorImpl(this.error, this.stackTrace, this.previousData);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('previousData', previousData));
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return error(this.error, stackTrace, previousData);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return error?.call(this.error, stackTrace, previousData);
  }
...
abstract class _Error<T> implements PaginationState<T> {
  const factory _Error(final Object error, final StackTrace stackTrace,
      final T? previousData) = _$ErrorImpl<T>;
